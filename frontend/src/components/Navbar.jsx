  ...
  >
    ...
    />
        ...
        <div className="flex items-center space-x-6">
          <span className="mr-4">Hey, {username}!</span>
          <Link to={`/cartpage`} className="flex items-center text-gray-800 hover:text-blue-600">
      ...
      <nav className="shadow-md" style={{ backgroundColor: '#8447ff' }}>
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          <div className="flex space-x-6">
            ...
            <a href="#" className="text-white hover:text-blue-200">Contact Us</a>
